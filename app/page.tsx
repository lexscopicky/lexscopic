    ...
    <div className="min-h-screen">
      <header className="sticky top-0 z-40 backdrop-blur bg-white/70 border-b">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <Button variant="outline" onClick={() => setOpenSubmit(true)} className="gap-2">
      ...
      <section className="max-w-6xl mx-auto px-4 py-6">
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
          <AnimatePresence>{filtered.map((evt) => <EventCard key={evt.id} evt={evt} />)}</AnimatePresence>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-4 pb-10 grid lg:grid-cols-3 gap-4">
        <Card className="lg:col-span-2">
          <CardHeader className="pb-2">
            <CardTitle>Partner with LexScopic</CardTitle>
          </CardHeader>
          <CardContent className="space-y-3 text-sm text-slate-600">
            <ul className="list-disc pl-5 space-y-1">
              <li>
                <b>Sponsored Events:</b> Highlighted listing with badge, top-of-list placement, and social shoutout.
              </li>
              <li>
                <b>Newsletter Feature:</b> First position in the weekly email with link.
              </li>
              <li>
                <b>Display Slots:</b> Banner and sidebar placements with monthly or weekly buys.
              </li>
              <li>
                <b>Affiliate Picks:</b> Optional ticketing partner links for eligible events.
              </li>
            </ul>
        ...
        <div className="grid md:grid-cols-2 gap-3">
          ...
          <div className="space-y-2 md:col-span-2">
            ...
            <Input
              ...
              placeholder="free, family, outdoors"
            />
          </div>
          <div className="space-y-2 md:col-span-2">
          ...
          <div className="space-y-2 md:col-span-2">
            ...
            <textarea
              className="w-full rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-slate-200"
              rows={4}
